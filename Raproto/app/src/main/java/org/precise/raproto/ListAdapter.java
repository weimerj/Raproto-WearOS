...
public class ListAdapter extends ArrayAdapter<ListsItem> {
    ...
    public ListAdapter(Context context, List<ListsItem> items, SwitchChangeListener switchChangeListener) {
